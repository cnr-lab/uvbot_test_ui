...
class TestAtestWindow(Ui_MainWindow_TestforAdam):
    ...
    def Receive_data(self):
        ...
        self.ultra_data3.setText(QCoreApplication.translate("MainWindow_TestforAdam", u"<html><head/><body><p><span style=\" color:#2e3436;\">{}</span></p></body></html>".format(self.func.ultrasound[2]), None))
        self.ultra_data4.setText(QCoreApplication.translate("MainWindow_TestforAdam", u"<html><head/><body><p><span style=\" color:#2e3436;\">{}</span></p></body></html>".format(self.func.ultrasound[3]), None))
